...
EXPECTED=5a64d26fbecdef8a33ae759cc7e0fedd7947d695
...
python -m pip install --disable-pip-version-check --requirement requirements-plan.txt
{
 ...
 HEPTABAO_V190_UNMERGED_CONVERGENCE=1 python "$WORK/prep/v170/materialize.py" . --asset-root "$WORK/prep/v170/assets"
