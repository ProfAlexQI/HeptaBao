...
encoded=(patch/'augment_external_v2.py.gz.b64').read_bytes()
encoded=encoded.replace(b'\r',b'').replace(b'\n',b'')
try:raw=gzip.decompress(base64.b64decode(encoded,validate=True))
except (OSError,EOFError):raw=module.recover_source(encoded)
